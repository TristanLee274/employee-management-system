# 🌐 Group 2: Web API & Data Persistence
...
|----------|--------------------------------------|-------------------------------|-------------|
| `GET`    | `/api/v1/employees`                 | Get employee list (pagination) | 200         |
| `GET`    | `/api/v1/employees/{id}`            | Get employee details          | 200         |
| `POST`   | `/api/v1/employees`                 | Create new employee           | 201         |
| `PUT`    | `/api/v1/employees/{id}`            | Full update                   | 200         |
| `PATCH`  | `/api/v1/employees/{id}`            | Partial update                | 200         |
| `DELETE` | `/api/v1/employees/{id}`            | Soft delete employee          | 204         |
| `GET`    | `/api/v1/employees/search`          | Advanced search               | 200         |
| `GET`    | `/api/v1/departments/{id}/employees`| Employees by department       | 200         |
| `POST`   | `/api/v1/projects/{id}/assignments` | Assign employee to project    | 201         |
...
spring:
  ...
  jpa:
    ...
    properties.hibernate:
      ...
      jdbc.batch_size: 25
    open-in-view: false  # ⚠️ Best practice: disable OSIV
  flyway:
    enabled: true
...
|---------|------|-------|
| Department → Employee | 1:N | 1 department has many employees |
| Department → Department | Self-ref | Department tree |
| Department → Project | 1:N | 1 department manages many projects |
| Employee ↔ Project | M:N | Via `project_assignments` table |
