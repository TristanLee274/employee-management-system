# 🧪 Group 4: Quality Assurance & Testing

## Table of Contents
1. [TDD — Test Driven Development](#1-tdd--test-driven-development)
2. [Unit Testing (JUnit 5 + Mockito)](#2-unit--integration-testing)
...
### 1.2. TDD Example: "Create Employee" Feature
...
**🔵 Step 3: REFACTOR — Optimize and clean up (tests must still pass)**
...
```
            ┌───────────┐
            │  E2E / BDD │  ← Least amount, slowest (Cucumber)
            │  (10-15%)  │
            ├───────────┤
            │Integration │  ← Medium amount (MockMvc, Testcontainers)
            │  (20-30%)  │
            ├───────────┤
            │ Unit Tests │  ← Largest amount, fastest (JUnit + Mockito)
            │  (60-70%)  │
            └───────────┘
```
