 ...
 *
 * <p>In the classic Observer Pattern:</p>
 * <pre>
 ...
 * </pre>
 *
 * <p>Kafka transforms this into a <strong>distributed, durable</strong> version:</p>
 * <pre>
 ...
 * </pre>
 *
 * <p><strong>This Record IS the event payload.</strong> It carries all information
 * needed by consumers without requiring them to query back to the producer.</p>
 *
 * <h2>WHY JAVA 21 RECORD FOR EVENTS?</h2>
 * <ul>
 *   <li><strong>Immutable:</strong> Once created, event data cannot be modified — essential
 *       for event sourcing integrity (events are facts, not mutable state)</li>
 *   <li><strong>Serialization-friendly:</strong> Records serialize/deserialize cleanly with
 *       Jackson (Kafka's JsonSerializer uses Jackson under the hood)</li>
 *   <li><strong>Self-documenting:</strong> The record components ARE the event schema</li>
 * </ul>
 *
...
public record EmployeeEvent(
     ...
     */
    public static EmployeeEvent created(String eventId, Long employeeId, String name,
     ...
     */
    public static EmployeeEvent updated(String eventId, Long employeeId, String name,
                                         String email, String department, String jobTitle,
     ...
     */
    public static EmployeeEvent deactivated(String eventId, Long employeeId, String name,
                                             String email) {
        return new EmployeeEvent(
